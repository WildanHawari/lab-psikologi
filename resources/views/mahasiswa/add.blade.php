    ...
    <div class="container mt-5 border rounded-4 mb-5 bg-white">
        <form class="row g-3 needs-validation p-4" action="/mahasiswaview/store" method="POST" novalidate>
            ...
            <div class="col-md-5">
                ...
                <select class="form-select @error('jurusan') is-invalid @enderror" name="jurusan" id="jurusan">
                    ...
                    <option value="Sistem Informasi" {{ old('jurusan') == 'Sistem Informasi' ? 'selected' : '' }}>
                        Sistem
                        Informasi</option>
                    <option value="Sistem Komputer" {{ old('jurusan') == 'Sistem Komputer' ? 'selected' : '' }}>
                        Sistem
                        Komputer</option>
            ...
            <div class="col-md-5">
                ...
                <select class="form-select @error('lokasi_kampus') is-invalid @enderror" name="lokasi_kampus" id="lokasi">
                    <option selected disabled value=""></option>
                    <option value="Depok" {{ old('lokasi_kampus') == 'Depok' ? 'selected' : '' }}>Depok</option>
                    <option value="Kalimalang" {{ old('lokasi_kampus') == 'Kalimalang' ? 'selected' : '' }}>Kalimalang
                    </option>
                </select>
                @error('lokasi_kampus')
                    <div class="invalid-feedback">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control @error('tempat_tanggal_lahir') is-invalid @enderror"
                    name="tempat_tanggal_lahir" id="tempat_tanggal_lahir" value="{{ old('tempat_tanggal_lahir') }}">
            ...
            <div class="col-md-6">
                ...
                <select class="form-select @error('posisi') is-invalid @enderror" name="posisi" id="posisi" value="{{ old('posisi') }}">
                    <option selected disabled value=""></option>
                    <option value="Programmer" {{ old('posisi') == 'Programmer' ? 'selected' : '' }}>Programmer
                    </option>
                    <option value="Asisten" {{ old('posisi') == 'Asisten' ? 'selected' : '' }}>Asisten</option>
                </select>
                @error('posisi')
                    <div class="invalid-feedback">
                        {{ $errors->first('posisi') }}
            ...
            <div class="col-12">
                ...
                <textarea class="form-control @error('alamat') is-invalid @enderror" name="alamat" id="alamat" rows="4">{{ old('alamat') }}</textarea>
                @error('alamat')
                    <div class="invalid-feedback">
                        {{ $errors->first('alamat') }}
                    </div>
            ...
            <div class="col-md-12">
                ...
                <input type="file" class="form-control @error('file') is-invalid @enderror" aria-label="file"
                    name="file" id="file" value="{{ old('file') }}" accept="application/pdf">
